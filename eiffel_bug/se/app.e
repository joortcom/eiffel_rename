...
feature {ANY}
   ...
   make is
	 ...
	 ra.print_ra()
	 io.put_string("PERSON  size: " +(p ).object_size.out+ "%N")
	 io.put_string("STUDENT size: " +(s ).object_size.out+ "%N")
	 io.put_string("FACULTY size: " +(f ).object_size.out+ "%N")
	 io.put_string("RESEARCH_ASSISTANT size: " +(ra).object_size.out+ "%N")
